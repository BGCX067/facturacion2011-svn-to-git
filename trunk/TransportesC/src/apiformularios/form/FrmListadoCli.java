...
public class FrmListadoCli extends javax.swing.JFrame {
    ...
    public FrmListadoCli(JInternalFrame i) {
          initComponents();
        this.jTable2.setModel(Utilitaria.listarClientes((DefaultTableModel) jTable2.getModel()));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 630, 360));
        ...
        getContentPane().add(txtNombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, 150, -1));
