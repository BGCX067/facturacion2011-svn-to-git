...
public class BrokerPagosAccess extends server.dom.Broker{
    ...
    public String getInsertCommand() {
        ...
        return "INSERT INTO PAGOS(NumeroPago, FechaPago, FacNro, Importe)" + "VALUES("+ Pag.getpNumeroPago() +",'" + Pag.getpFechaPago()+"',"+Pag.getpObjFactura().getfCod()+
                  ","+Pag.getpImportePago() +")";
    ...
    public String getUpdateCommand() {
        Pago Pag =(Pago)this.getObjP();
        return "UPDATE PAGOS SET FechaPago='" + Pag.getpFechaPago()+ "',FacNro="+Pag.getpObjFactura().getfCod()
